      ...
      <div className="no-print bg-white p-2 sm:p-2.5 rounded-xl sm:rounded-2xl border border-slate-200 shadow-xs flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
          ...
          <div className="flex items-center gap-1.5 bg-slate-50 px-2 py-1 rounded-lg border border-slate-200">
            ...
            <select
              ...
              className={`bg-transparent text-xs font-bold text-slate-800 pr-1 py-0.5 outline-hidden cursor-pointer ${
                activeMode === 'monthly' ? 'border-l border-slate-200 pl-1.5' : ''
              }`}
            >
        ...
        <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
          ...
          <button
            ...
            title="Cetak atau simpan laporan laba rugi ke format PDF"
          >
